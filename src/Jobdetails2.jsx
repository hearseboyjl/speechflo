        ...
        <section className="mt-8 flex min-h-0 flex-1 flex-col rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="min-h-0 flex-1 overflow-auto p-6 sm:p-8">
            ...
            <div>
              ...
              <div className="mt-3 space-y-5 text-sm leading-6 text-slate-700">
                <div>
                  ...
                  <ul className="mt-2 list-disc space-y-2 pl-5">
                    <li>
                      Supervise bookkeepers and oversee accounts payable/receivable and
                      payroll-related entries.
                    </li>
                    <li>
                      Manage daily journal entries, sales encoding, and expense tracking.
                    </li>
                    <li>
                      Lead the month-end closing process, ensuring timely and accurate
                      schedules and adjusting entries.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-2 list-disc space-y-2 pl-5">
                    <li>
                      Prepare consolidated income statements, balance sheets, and cash flow
                      statements.
                    </li>
                    <li>
                      Ensure accuracy and completeness of inter-branch and consolidated
                      reports.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-2 list-disc space-y-2 pl-5">
                    <li>
                      Monitor accounts payable aging and manage vendor payment scheduling.
                    </li>
                    <li>
                      Reconcile store sales with bank deposits on a weekly basis and
                ...
                <div>
                  ...
                  <ul className="mt-2 list-disc space-y-2 pl-5">
                    <li>
                      Enforce internal finance SOPs, including Chart of Accounts usage and
                      voucher control.
                    </li>
                    <li>
                      Coordinate with the Compliance team for audit preparation and
                      documentation.
                    </li>
                  </ul>
                </div>
              ...
              <h2 className="mt-10 text-base font-bold text-sky-700">Qualifications</h2>
              <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700">
                <li>CPA license preferred but not mandatory.</li>
                <li>
                  Minimum of 4 years accounting experience, preferably in the food &amp;
                  beverage or retail sector.
                </li>
                <li>Proven experience in supervising accounting teams.</li>
                <li>
                  Proficient in accounting systems such as Odoo, QuickBooks, SAP, or
                  similar platforms.
                </li>
              ...
              <h3 className="mt-8 text-base font-bold text-sky-700">Requirements</h3>
              <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700">
