            ...
            <div>
              ...
              <div className="mt-3 space-y-6 text-sm leading-6 text-slate-700">
                <ul className="list-disc space-y-2 pl-5">
                  <li>Experience: At least supervisor level in the fast-food or restaurant industry.</li>
                  <li>Education: Senior High School graduate to College level (College undergraduates are welcome to apply).</li>
                  <li>Health &amp; Fitness: Can handle a super fast-paced environment.</li>
                </ul>

                <div>
                  <p className="font-semibold text-[#000080]">Character Requirements:</p>
