...
export default function Homepage() {
  ...
  useEffect(() => {
    const update = () => {
      ...
      setHeaderH(rounded);
      // expose header height globally for consistent calculations if needed
  ...
  // Close menu when switching out of mobile
  useEffect(() => {
    const onResize = () => {
  ...
  // Palette
  const PAGE_BG = "app-bg"; // <- your gradient class
  ...
  // ✅ cursor-pointer added here so all nav buttons show pointer
  const navBtn =
    ...
    <div className={`min-h-screen w-full ${PAGE_BG}`}>
      ...
      >
        <div className={`${CONTAINER} py-10 sm:py-14 lg:py-16`}>
          ...
          <div className="mt-8 sm:mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 xl:gap-14 items-stretch">
      ...
      <section id="footer" className="w-full bg-[#002853]">
        <div className={`${CONTAINER} py-10`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-10 text-white/90 text-[13px] sm:text-[14px] items-start">
