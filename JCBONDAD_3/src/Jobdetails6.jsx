          ...
          <div className="min-h-0 flex-1 overflow-auto p-6 sm:p-8">
            ...
            <div>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700">
                ...
                <li>
                  Ensure proper documentation, storage, and stock reporting by
                  storekeepers.
                </li>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700">
                ...
                <li>
                  At least 3–5 years of experience in commissary operations,
                ...
                <li>
                  Proficient in inventory systems, production planning, and
                  cost control.
                </li>
                <li>
                  Knowledgeable in food safety standards and preventive
                  maintenance.
                </li>
