  ...
  return (
    <div className={`min-h-screen w-full ${PAGE_BG}`}>
      ...
      <header ref={headerRef} className="sticky top-0 z-50">
        <div className="w-full bg-[#e6f1f8]/95 backdrop-blur border-b border-black/10 shadow-sm">
  ...
  />
              ...
              <div className="flex items-center gap-3 sm:gap-6">
                ...
                <button
                  ...
                  className="h-7 w-7 sm:h-8 sm:w-8 xl:h-9 xl:w-9 rounded-full bg-[#1E63D6] text-white font-bold"
                >
                  f
                </button>
              </div>
    ...
    >
      <div className="bg-white/95 rounded-3xl shadow-lg px-6 sm:px-8 lg:px-10 py-7 sm:py-9">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12">
          {/* Left */}
          <div>
            <h1 className="font-extrabold leading-tight text-black text-[clamp(2rem,4vw,5.5rem)]">
